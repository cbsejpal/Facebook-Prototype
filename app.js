...
var express = require('express'), routes = require('./routes'), http = require('http'), path = require('path'), login = require('./routes/login'), logout = require('./routes/logout');

// testing mongoose

var registerM = require('./routes/registerM'), loginM = require('./routes/loginM'), profileM = require('./routes/profileM'), aboutM = require('./routes/aboutM'), timelineM = require('./routes/timelineM'), homepageM = require('./routes/homepageM'), groupM = require('./routes/groupM'), getFrndsM = require('./routes/getFrndsM'), getJsonTimelineM = require('./routes/getJsonTimelineM'), searchM = require('./routes/searchM');
...
app.get('/groupsM', groupM.listGroupsOfUserPage);
...
app.post('/checkFriendStatusM', getJsonTimelineM.checkFriendStatus);
...
app.post('/cancelFriendRequest', getJsonTimelineM.sendFriendRequest);
...
app.post('/addInGroupM', groupM.addInGroup);
